    ...
    ---------------------*/
        ...
        .contact-form .form-control {
            border: none;
            border-bottom: 1px solid  #0e2737;
                ...
                <div class="col-lg-8 m-15px-tb">
                    <article class="article">
                        <div class="article-img">
                            <img src="{{asset('images/blogs/'.$blog->image)}}" title="" alt="fgfdgfd">
                        </div>
                        <div class="article-title">
                            <h6><a href="#">mountain</a></h6>
                            <h2>{{$blog->title}}</h2>
                            <div class="media">
                                <div class="avatar">
                                    <img src="{{asset('images/blogs'.$blog->image)}}" title=""
                                        alt="">
                                </div>
                    ...
                    <div class="widget widget-author">
                        ...
                        <div class="widget-body">
                            <div class="media align-items-center">
                                <div class="avatar">
                                    <img src="{{asset($blog->user->image)}}" title=""
                                        alt="">
                                </div>
                                <div class="media-body">
                    ...
                    <div class="widget widget-latest-post">
                        ...
                        <div class="widget-body">
                            <div class="latest-post-aside media">
                                ...
                                <div class="lpa-right">
                                    <a href="#">
                                        <img src="https://images.designtrends.com/wp-content/uploads/2016/04/06100129/Mountain-Wallpapers.jpg" title=""
                                            alt="">
                                    </a>
                                </div>
                            </div>
