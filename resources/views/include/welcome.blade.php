    ...
    <section class="welcome-area">
        <div class="welcome-slides owl-carousel">
            ...
            <div class="single-welcome-slide bg-img bg-overlay"
                style="background-image: url({{ asset('website/img/bg-img/16.jpg') }});"
                data-img-url="{{ asset('website/img/bg-img/16.jpg') }}">
                <!-- Welcome Content -->
            ...
            <!-- Single Welcome Slide -->
            <div class="single-welcome-slide bg-img bg-overlay"
                style="background-image: url({{ asset('website/img/bg-img/17.jpg') }});"
                data-img-url="{{ asset('website/img/bg-img/17.jpg') }}">
                <!-- Welcome Content -->
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
            ...
            <!-- Single Welcome Slide -->
            <div class="single-welcome-slide bg-img bg-overlay"
                style="background-image: url({{ asset('website/img/bg-img/18.jpg') }});"
                data-img-url="{{ asset('website/img/bg-img/18.jpg') }}">
                <!-- Welcome Content -->
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
