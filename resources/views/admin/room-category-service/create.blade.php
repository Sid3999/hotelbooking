...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Room Services<small>Create</small></h1>
            <ol class="breadcrumb">
        ...
        <section class="content container-fluid">
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading bg-primary">Create Room Services</div>
                    <div class="panel-body">
                        ...
                        {{-- @can('permission-write') --}}
                            ...
                            <form action="{{ route('room-category-service.store') }}" method="post"
