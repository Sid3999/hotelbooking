...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Room Gallery<small>Create</small></h1>
            <ol class="breadcrumb">
        ...
        <section class="content container-fluid">
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading bg-primary">Create Room Gallery</div>
                    <div class="panel-body">
                        ...
                        {{-- @can('permission-write') --}}
                            ...
                            <form action="{{ route('room-category-gallery.store') }}" method="post"
                                            ...
                                            <div class="col-md-12">
                                                <div id=" input-group">
                                                    <div class="form-group col-md-6">
                                                        <label for="category_id">Add room Images</label>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <button type="submit" class="btn btn-md btn-success">Add Services</button>
                                    </div>
                                </div>
                            </form>
                        {{-- @else
