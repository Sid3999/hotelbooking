...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Room Gallery<small>Edit</small></h1>
            <ol class="breadcrumb">
                <li><a href="{{ route('room-category-service.index') }}"><i class="fa fa-users"></i>Room Gallery</a></li>
        ...
        <section class="content container-fluid">
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading bg-primary">Edit Room Gallery</div>
                    <div class="panel-body">

                        <!-- errors -->
                        {{-- @include('admin.partials.errors') --}}
                        {{-- @can('permission-write') --}}
                            <form action="{{ route('room-category-gallery.update', $RoomCateGallery->id) }}" method="post"
                                            ...
                                            <div class="col-md-12">
                                                <div id=" input-group">
                                                    <div class="form-group col-md-6">
                                                        <label for="category_id">Choose Images</label>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <button type="submit" class="btn btn-md btn-success">Edit Gallery</button>
                                    </div>
                                </div>
                            </form>
                        {{-- @else
...
@section('title', 'Room Category Gallery|Create')
