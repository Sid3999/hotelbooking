                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <div class="button-group">
                            ...
                            @endcan
                            @if($user->is_active == 1)
                            <a href="javascript::void(0)" class="ban-user" data-id="{{$user->id}}" title="Click to Ban the user"><span class="fa fa-user-times text-danger"></span></a>
                            @else
                            <a href="javascript::void(0)" class="ban-user" data-id="{{$user->id}}" title="Click to Unban the user"><span class="fa fa-user text-success"></span></a>
                            @endif
                            {{-- @can('user-delete')
...
<script>
  ...
  $('body').on('click', '.ban-user', function(e) {
    var confirmed = false;
    swal({
